package com.mounthuang.test.con.core.utils.godeye;
...
public class GodEyeLogAspect {
    @Pointcut(value = "within(@com.mounthuang.test.con.core.utils.godeye.GodEyeLog *) "
            + "|| @annotation(com.mounthuang.test.con.core.utils.godeye.GodEyeLog)")
